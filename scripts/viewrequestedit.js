...
//Gets details about a request post
function getPostDetails() {
    return new Promise ((resolve) => {
        $.get('http://'+window.location.host+'/viewrequestpostdeets', (data) => {
...
//Renders these details
function renderPost(post){
    $('#requestDescription').val(post.postDescription)
}
