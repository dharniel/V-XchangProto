...
//Renders these details in the form
function renderPost(post){
    $('#textbookTitle').val(post.postBookTitle)
    $('#textbookAuthor').val(post.postBookAuthor)
    $('#textbookCourse').val(post.postCourseCode  + " : " + post.postCourseTitle)
    $('#textbookCost').val(post.postBookCost)
    $('#textbookDescription').val(post.postDescription)
}